...
import database, models, hashing, schemas, token_access, oauth2
...
def get_current_user(session: database.SessionLocal, token: str = Depends(oauth2.oauth2_scheme)) -> models.User:
    try:
