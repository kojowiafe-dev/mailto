...
const industries = [
  ...
  },
  {
    title: "Healthcare",
    description:
      "AI-powered diagnostics, patient engagement tools, and predictive care workflows.",
    icon: LucideHospital,
  },
  {
    title: "Education",
  ...
  },
  {
    title: "Security",
    description:
      "Real-time threat detection, smart surveillance, and AI-enhanced cybersecurity.",
  ...
  return (
    ...
    >
      <Card className="bg-gray-900 hover:bg-gray-800 transition-colors duration-300 shadow-md rounded-2xl p-6 text-left">
        ...
        <CardContent className="text-sm text-gray-400 pt-2">
          {description}
        </CardContent>
      </Card>
    </motion.div>
...
export default function IndustriesSection() {
  return (
    <section className="w-full bg-black text-white pt-24 md:pt-28 pb-24 px-6 md:px-20">
      <div className="max-w-7xl mx-auto text-center">
        ...
        >
          Solutions Built for{" "}
          <span className="text-blue-500">Your Industry</span>
        </motion.h2>
        ...
        >
          Eventus delivers tailored, AI-powered solutions for sectors where
          performance, precision, and personalization matter.
        </motion.p>
