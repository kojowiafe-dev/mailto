  ...
  return (
    <div className='p-3 mt-10'>
        <section className='mb-10 relative'>
          ...
          <motion.h1 initial={{ opacity: 0, x: 100 }} animate={{ opacity: 1, x: 0 }} transition={{ type: 'spring', stiffness: 100 , damping: 10, delay: 0.7 }} className='text-[180px] scale-150 font-bold text-gray-400/15 select-none z-0 inset-0 fixed top-50 left-0.5 -translate-x-0.5 -translate-y-0.5 pointer-events-none'>EVENTUS</motion.h1>
